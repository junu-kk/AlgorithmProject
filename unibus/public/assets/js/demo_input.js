    ...
    initFullCalendar: function(){
        ...
        $calendar.fullCalendar({
			...
			select: function(start, end) {
              ...
              hiddenField.setAttribute('value', eventData.title);
              form.appendChild(hiddenField);

              var hiddenField = document.createElement('input');
              hiddenField.setAttribute('type', 'hidden');
              hiddenField.setAttribute('name', 'start');
              hiddenField.setAttribute('value', eventData.start);
              form.appendChild(hiddenField);

              var hiddenField = document.createElement('input');
              hiddenField.setAttribute('type', 'hidden');
              hiddenField.setAttribute('name', 'end');
              hiddenField.setAttribute('value', eventData.end);
              form.appendChild(hiddenField);
